export default {
    ...
    videoEditor: {
        ...
        untitled: "未命名剪辑",
        projectName: "工程名称",
        backToStudio: "返回视频创作台",
        autoSaved: "自动保存",
        newProject: "新建剪辑工程",
        newProjectConfirm: "当前剪辑草稿会被清空，是否继续？",
        addAsset: "添加素材",
        importVideo: "导入视频",
        exportProject: "导出工程",
        projectExported: "工程 JSON 已导出",
        timeline: "多轨时间线",
        emptyTitle: "从一段视频开始",
        emptyDescription: "从我的资产选择视频，或导入本地 MP4、MOV、WebM 文件。剪辑工程会保存在当前浏览器。",
        videoOnly: "剪辑器当前仅支持视频资产",
        videoAdded: "视频已加入时间线",
        overlayAdded: "画中画素材已加入时间线",
        source: "视频剪辑器",
        loadFailed: "读取剪辑草稿失败",
        saveFailed: "保存剪辑草稿失败",
        readFailed: "无法读取视频，请重新选择文件",
        importFailed: "导入视频失败",
        playbackFailed: "视频预览失败，请检查文件格式",
    },
    canvas: {
        ...
        workspace: { canvas: "画布", edit: "剪辑" },
        edit: { emptyTitle: "把画布素材排进时间线", emptyDescription: "左侧素材箱可点击视频或音频加入时间线，也可以让右侧 Agent 按顺序组织这些素材。图片暂不能直接上时间线。", addToTimeline: "加入时间线", clipAdded: "已加入时间线", addFailed: "加入时间线失败", imageNotSupported: "剪辑器暂不支持把图片放到时间线", mediaOnly: "请选择有内容的视频或音频", notReady: "剪辑器尚未就绪" },
        connecting: "连接中",
