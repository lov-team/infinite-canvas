export default {
    ...
    videoEditor: {
        ...
        newProjectConfirm: "This clears the current editing draft. Continue?",
        addAsset: "Add media",
        importVideo: "Import video",
        exportProject: "Export project",
        projectExported: "Project JSON exported",
        timeline: "Multitrack timeline",
        emptyTitle: "Start with a video",
        emptyDescription: "Choose a video from My Assets or import a local MP4, MOV, or WebM file. The editing project is saved in this browser.",
        videoOnly: "The editor currently supports video assets only",
        videoAdded: "Video added to the timeline",
        overlayAdded: "Picture-in-picture media added",
        source: "Video Editor",
        loadFailed: "Failed to load the editing draft",
        saveFailed: "Failed to save the editing draft",
        readFailed: "Unable to read this video. Choose another file.",
        importFailed: "Failed to import the video",
        playbackFailed: "Video preview failed. Check the file format.",
    },
    canvas: {
        ...
        workspace: { canvas: "Canvas", edit: "Edit" },
        edit: { emptyTitle: "Arrange canvas media on the timeline", emptyDescription: "Click a video or audio item in the left panel to add it, or ask the Agent to organize these assets. Still images cannot be placed on the timeline yet.", addToTimeline: "Add to timeline", clipAdded: "Added to the timeline", addFailed: "Failed to add to the timeline", imageNotSupported: "Still images cannot be placed on the timeline yet", mediaOnly: "Choose a video or audio item that has content", notReady: "The editor is not ready yet" },
