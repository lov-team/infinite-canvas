...
- Generate or rewrite text, create images, edit images from references, and create videos. MiniMax H3 text-to-video, first/last frames, and general reference are covered in [MiniMax H3 Video](/docs/canvas/minimax-h3-video).
